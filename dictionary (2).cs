...
namespace Dictionary.cs
{
    class Program
    {
        ...
        {
            Dictionary<string, string> recipes = new Dictionary<string, string>(); //creating new dictionary with 2 string types
            ...
            if (recipes.TryGetValue("Sandwich", out string example)) //if this exists, outputs dictionary
            {
